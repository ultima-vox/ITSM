...
export const RBAC_PERMISSIONS: RbacPermission[] = [
  ...
  { key: 'work-item.comment.internal', description: 'Create and view internal notes' },
  ...
  { key: 'attachment.read.any', description: 'Read attachments across service records' },
